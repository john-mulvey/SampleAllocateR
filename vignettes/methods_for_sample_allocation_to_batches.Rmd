...
```{r}
table(optimal_layout_blocked$layout$batch_allocation)


tmp = allocate_single_random(data = toy_data, 
                       batch_size = 13, 
                       blocking_variable = "block_id")

table(tmp$layout$batch_allocation)

tmp2 = allocate_best_random(data = toy_data, 
                       batch_size = 13, 
                       blocking_variable = "block_id",
                       iterations = 100)

table(tmp2$layout$batch_allocation)
```
